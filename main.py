...
def Validate_email():
    ...
    return render_template('Recovery/validator_email.html', account_found=session["account"], email= str(session["email"])) 
...
def New_password():
    ...
    return render_template('Recovery/New_password.html')
